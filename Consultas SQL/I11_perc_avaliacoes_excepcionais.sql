...
-- Revisado: 23.05.2026
-- =========================================================
-- PRÉ-REQUISITO: confirmar que nota = 5 corresponde a 'Excepcional'
--   no banco (verificar tipos_avaliacoes_notas).
-- MESMA ESTRUTURA DO I09/I10; o filtro muda para nota = 5.
-- LEITURA CONJUNTA COM I10:
--   alta nota 5 + baixa nota 2 → distribuição saudável
--   alta em ambos os extremos → bimodalidade (notas 3 e 4 subutilizadas)
-- NÍVEIS DE RECONHECIMENTO:
--   >= 40% Reconhecimento elevado | >= 20% Desempenho diferenciado
--   >=  5% Destaque pontual       | <  5% Escala subutilizada
-- =========================================================
